...
async def test_messenger_pub_sub_cb():
    ...
    pub = await get_publisher('test.messenger.test_messenger_pub_sub_cb')
    sub = await get_callbacksubscriber('test.messenger.test_messenger_pub_sub_cb', deliver_policy='all')
