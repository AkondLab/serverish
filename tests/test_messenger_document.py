...
@pytest.mark.nats
async def test_document_reader_initial_read(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_no_initial_document(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_updates(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_subtree_updates(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_multiple_updates(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_context_manager(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_explicit_close(messenger, unique_subject):
...
@pytest.mark.nats
async def test_get_live_document_convenience(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_with_callbacks(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_removed_subtree(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_empty_to_populated(messenger, unique_subject):
...
@pytest.mark.nats
async def test_document_reader_concurrent_readers(messenger, unique_subject):
